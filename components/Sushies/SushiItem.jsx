    ...
    <div className={`border border-gray-300 rounded-xl overflow-hidden shadow-lg transition transform hover:scale-105 hover:shadow-xl max-w-sm ${bgColor}`}>
      ...
      <div className="p-4 text-center">
        ...
        <Button 
          ...
          className="w-full bg-gradient-to-r from-red-500 to-yellow-400 text-white font-medium py-2 rounded-full hover:from-yellow-500 hover:to-red-500 transition duration-300 transform hover:scale-105"
        />
      </div>
    </div>
  );
